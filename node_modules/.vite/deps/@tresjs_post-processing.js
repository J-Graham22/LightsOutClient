import {
  ...
  useTres,
  useTresContext
} from "./chunk-KWLL6CAA.js";

// node_modules/@tresjs/post-processing/dist/tres-post-processing.js
...
`;
    ...
    const shaders = /* @__PURE__ */ new Map([["fragment", fragmentShader2], ["vertex", vertexShader]]);
...
// node_modules/@tresjs/post-processing/dist/tres-post-processing.js
import { HalfFloatType as HalfFloatType3, Mesh as Mesh2, MeshBasicMaterial, SphereGeometry, Uniform as Uniform52, Vector2 as Vector229, Vector3 as Vector39 } from "three";
...
var effectComposerInjectionKey$1 = /* @__PURE__ */ Symbol("effectComposerPmndrs");
var EffectComposerPmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const effectComposerParams = computed(() => {
      ...
      const params = {
        ...
        frameBufferType: props.frameBufferType !== void 0 ? props.frameBufferType : HalfFloatType3
      };
...
var useEffectPmndrs = (newEffectFunction, passDependencies, dependencyFieldsTriggeringRecreation) => {
...
var omit = (obj, properties) => {
  const newObj = { ...obj };
  properties.forEach((prop) => delete newObj[prop]);
  return newObj;
};
var makePropWatcher = (propGetter, target, propertyPath, newPlainObjectFunction, watchOptions = {}) => watch(propGetter, (newValue) => {
...
var makePropWatchers = (propGettersAndPropertyPaths, target, newPlainObjectFunction) => propGettersAndPropertyPaths.map(([propGetterFn, path]) => makePropWatcher(propGetterFn, target, path, newPlainObjectFunction));
var makePropWatchersUsingAllProps = (props, target, newPlainObjectFunction) => Object.keys(props).map((key) => makePropWatcher(() => props[key], target, key, newPlainObjectFunction));
var BloomPmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
  __name: "BloomPmndrs",
  props: {
    blendFunction: {
      type: null,
...
var DepthOfFieldPmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
...
var GlitchPmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
  __name: "GlitchPmndrs",
  props: {
    blendFunction: {
      type: null,
...
var NoisePmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
  __name: "NoisePmndrs",
  props: {
    premultiply: {
      type: Boolean,
...
var OutlinePmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const props = __props;
    const colorToNumber = (color2) => color2 !== void 0 ? normalizeColor(color2).getHex() : void 0;
...
var PixelationPmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
...
var VignettePmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
...
var BarrelBlurEffect = class extends Effect {
  ...
  *
  */
  constructor({ blendFunction = BlendFunction.NORMAL, amount = 0.15, offset = new Vector229(0.5, 0.5) } = {}) {
    ...
    void mainImage(const in vec4 inputColor, const in vec2 uv, out vec4 outputColor) {
      ...
      `, {
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([["amount", new Uniform52(amount)], ["offset", new Uniform52(offset)]])
    });
  }
  /**
  * The amount.
...
var BarrelBlurPmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const { pass, effect } = useEffectPmndrs(() => new BarrelBlurEffect({
      ...props,
      offset: Array.isArray(props.offset) ? new Vector229(...props.offset) : props.offset
    }), props);
    __expose({
      pass,
      effect
...
var ToneMappingPmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
...
var ChromaticAberrationPmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
...
var HueSaturationPmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
...
var ScanlinePmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  */
  constructor({ blendFunction = BlendFunction.NORMAL, radius = 1, sectorCount = 4 } = {}) {
    super("KuwaharaEffect", fragmentShader, {
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([["radius", new Uniform52(radius)], ["sectorCount", new Uniform52(sectorCount)]])
    });
  }
  /**
  * The radius.
...
var KuwaharaPmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
...
var ColorAveragePmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
...
var LensDistortionPmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const { pass, effect } = useEffectPmndrs(() => new LensDistortionEffect({
      ...props,
      distortion: props.distortion ? Array.isArray(props.distortion) ? new Vector229(...props.distortion) : props.distortion : new Vector229(),
      principalPoint: props.principalPoint ? Array.isArray(props.principalPoint) ? new Vector229(...props.principalPoint) : props.principalPoint : new Vector229(),
      focalLength: props.focalLength ? Array.isArray(props.focalLength) ? new Vector229(...props.focalLength) : props.focalLength : new Vector229()
    }), props);
    __expose({
      pass,
      effect
...
var ShockWavePmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const props = __props;
    const { camera } = useTres();
    const { pass, effect } = useEffectPmndrs(() => new ShockWaveEffect(camera.value, Array.isArray(props.position) ? new Vector39(...props.position) : props.position, props), props);
    __expose({
      pass,
      effect
    });
    watch(() => props.position, (newPosition) => {
      ...
      else if (newPosition instanceof Vector39) effect.value.position.copy(newPosition);
    }, { immediate: true });
    makePropWatchers([
...
var TiltShiftPmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
...
var DotScreenPmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
...
var SepiaPmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
  __name: "SepiaPmndrs",
  props: {
    blendFunction: {
      type: null,
...
var LinocutEffect = class extends Effect {
  ...
  *
  */
  constructor({ blendFunction = BlendFunction.NORMAL, scale = 0.85, noiseScale = 0, center = [0.5, 0.5], rotation = 0 } = {}) {
    const centerVec = Array.isArray(center) ? new Vector229().fromArray(center) : center;
    super("LinocutEffect", `
    uniform float scale;
    ...
    `, {
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([
        ["scale", new Uniform52(scale)],
        ["noiseScale", new Uniform52(noiseScale)],
        ["center", new Uniform52(centerVec)],
        ["rotation", new Uniform52(rotation)]
      ])
    });
  }
  get scale() {
  ...
  set center(value) {
    this.uniforms.get("center").value = Array.isArray(value) ? new Vector229().fromArray(value) : value;
  }
  get rotation() {
...
var LinocutPmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const { pass, effect } = useEffectPmndrs(() => new LinocutEffect({
      ...props,
      center: props.center instanceof Vector229 ? [props.center.x, props.center.y] : props.center
    }), props);
    __expose({
      pass,
      effect
...
var DepthPickingPassPmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
...
var GodRaysPmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const props = __props;
    const { camera } = useTres();
    const resolvedLightSource = computed(() => props.lightSource ?? new Mesh2(new SphereGeometry(1e-5), new MeshBasicMaterial({ visible: false })));
...
var ColorDepthPmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
...
var GridPmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
  __name: "GridPmndrs",
  props: {
    blendFunction: {
      type: null,
...
var FishEyeEffect = class extends Effect {
  ...
  *
  */
  constructor({ blendFunction = BlendFunction.NORMAL, lensS = new Vector229(1, 1), lensF = new Vector229(0, 1), scale = 1 } = {}) {
    super("FishEyeEffect", `
      uniform vec2 lensS;
      uniform vec2 lensF;
      uniform float scale;
      ...
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([
        ["lensS", new Uniform52(lensS)],
        ["lensF", new Uniform52(lensF)],
        ["scale", new Uniform52(scale)]
      ])
    });
  }
...
var FishEyePmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const props = __props;
    const computedLensS = computed(() => Array.isArray(props.lensS) ? new Vector229(...props.lensS) : props.lensS);
    const computedLensF = computed(() => Array.isArray(props.lensF) ? new Vector229(...props.lensF) : props.lensF);
...
var BrightnessContrastPmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
...
var SMAAPmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
  __name: "SMAAPmndrs",
  props: {
    blendFunction: {
      type: null,
...
var FXAAPmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
  __name: "FXAAPmndrs",
  props: {
    blendFunction: {
      type: null,
...
var TexturePmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
...
var ASCIIPmndrs_vue_vue_type_script_setup_true_lang_default = defineComponent({
  __name: "ASCIIPmndrs",
  props: {
    blendFunction: {
      type: null,
...
var effectComposerInjectionKey = /* @__PURE__ */ Symbol("effectComposerThree");
var EffectComposer_vue_vue_type_script_setup_true_lang_default = defineComponent({
...
var useEffect = (newPassFunction, passDependencies, dependencyFieldsTriggeringRecreation) => {
...
var Glitch_vue_vue_type_script_setup_true_lang_default = defineComponent({
  __name: "Glitch",
  props: {
    dtSize: {
      type: Number,
...
var Halftone_vue_vue_type_script_setup_true_lang_default = defineComponent({
  __name: "Halftone",
  props: {
    shape: {
      type: Number,
...
var Pixelation_vue_vue_type_script_setup_true_lang_default = defineComponent({
  __name: "Pixelation",
  props: {
    pixelSize: {
      type: Number,
...
var Output_vue_vue_type_script_setup_true_lang_default = defineComponent({
  __name: "Output",
  setup(__props, { expose: __expose }) {
...
var SMAA_vue_vue_type_script_setup_true_lang_default = defineComponent({
  __name: "SMAA",
  props: {
    width: {
      type: Number,
...
var UnrealBloom_vue_vue_type_script_setup_true_lang_default = defineComponent({
  __name: "UnrealBloom",
  props: {
    radius: {
      type: Number,
  ...
  setup(__props, { expose: __expose }) {
    const props = __props;
    const { sizes } = useTresContext();
    const { pass } = useEffect(() => new UnrealBloomPass(new Vector229(sizes.width.value, sizes.height.value), props.strength, props.radius, props.threshold), props);
    __expose({ pass });
    watchEffect(() => {
      pass.value.radius = props.radius ?? pass.value.getCompositeMaterial().uniforms.bloomRadius?.value ?? 0.1;
    });
    watchEffect(() => {
...
export {
  ASCIIPmndrs_default as ASCIIPmndrs,
  BarrelBlurPmndrs_default as BarrelBlurPmndrs,
  BloomPmndrs_default as BloomPmndrs,
  BrightnessContrastPmndrs_default as BrightnessContrastPmndrs,
  ChromaticAberrationPmndrs_default as ChromaticAberrationPmndrs,
  ColorAveragePmndrs_default as ColorAveragePmndrs,
  ColorDepthPmndrs_default as ColorDepthPmndrs,
  DepthOfFieldPmndrs_default as DepthOfFieldPmndrs,
  DepthPickingPassPmndrs_default as DepthPickingPassPmndrs,
  DotScreenPmndrs_default as DotScreenPmndrs,
  EffectComposer_default as EffectComposer,
  EffectComposerPmndrs_default as EffectComposerPmndrs,
  FXAAPmndrs_default as FXAAPmndrs,
  FishEyePmndrs_default as FishEyePmndrs,
  Glitch_default as Glitch,
  GlitchPmndrs_default as GlitchPmndrs,
  GodRaysPmndrs_default as GodRaysPmndrs,
  GridPmndrs_default as GridPmndrs,
  Halftone_default as Halftone,
  HueSaturationPmndrs_default as HueSaturationPmndrs,
  KuwaharaPmndrs_default as KuwaharaPmndrs,
  LensDistortionPmndrs_default as LensDistortionPmndrs,
  LinocutPmndrs_default as LinocutPmndrs,
  NoisePmndrs_default as NoisePmndrs,
  OutlinePmndrs_default as OutlinePmndrs,
  Output_default as Output,
  Pixelation_default as Pixelation,
  PixelationPmndrs_default as PixelationPmndrs,
  SMAA_default as SMAA,
  SMAAPmndrs_default as SMAAPmndrs,
  ScanlinePmndrs_default as ScanlinePmndrs,
  SepiaPmndrs_default as SepiaPmndrs,
  ShockWavePmndrs_default as ShockWavePmndrs,
  TexturePmndrs_default as TexturePmndrs,
  TiltShiftPmndrs_default as TiltShiftPmndrs,
  ToneMappingPmndrs_default as ToneMappingPmndrs,
  UnrealBloom_default as UnrealBloom,
  VignettePmndrs_default as VignettePmndrs,
  useEffect,
  useEffectPmndrs
};
